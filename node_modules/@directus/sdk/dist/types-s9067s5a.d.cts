import { b as WebSocketInterface } from './client-pzVdw9Ub.cjs';
...
type DirectusExtension<Schema extends object> = {
    name: string;
    bundle: string | null;
 ...
 */
type FilterOperators<FieldType, T = FieldType extends keyof FieldOutputMap ? FieldOutputMap[FieldType] : FieldType> = {
    _eq?: T;
    _neq?: T;
    _gt?: T;
    _gte?: T;
...
export type { FilterOperators as $, DirectusRole as A, DirectusSettings as B, CollectionMetaTranslationType as C, DirectusActivity as D, ExtensionSchema as E, FieldMetaConditionType as F, DirectusShare as G, DirectusUser as H, DirectusVersion as I, DirectusWebhook as J, QueryFields as K, WrapQueryFields as L, QueryFieldsRelational as M, ManyToAnyFields as N, HasManyToAnyRelation as O, HasNestedFields as P, QueryDeep as Q, RemoveEventHandler as R, SubscribeOptions as S, FieldsWildcard as T, PickRelationalFields as U, PickFlatFields as V, WebSocketAuthModes as W, LiteralFields as X, QueryFilter as Y, NestedQueryFilter as Z, NestedRelationalFilter as _, WebSocketConfig as a, RelationalFilterOperators as a0, WrapRelationalFilters as a1, LogicalFilterOperators as a2, WrapLogicalFilters as a3, ApplyQueryFields as a4, ApplyManyToAnyFields as a5, ApplyNestedQueryFields as a6, RelationNullable as a7, MapFlatFields as a8, FieldOutputMap as a9, IfNever as aA, IfAny as aB, IsAny as aC, IsNullable as aD, NestedPartial as aE, Identity as aF, DateTimeFunctions as aG, ArrayFunctions as aH, MappedFunctionFields as aI, MappedFieldNames as aJ, Query as aa, QueryItem as ab, ExtractItem as ac, ExtractRelation as ad, MergeRelationalFields as ae, MergeFields as af, QuerySort as ag, MergeObjects as ah, QueryAlias as ai, ItemType as aj, CollectionType as ak, SingletonCollections as al, RegularCollections as am, PrimitiveFields as an, RelationalFields as ao, RemoveRelationships as ap, MergeCoreCollection as aq, CompleteSchema as ar, AllCollections as as, GetCollection as at, GetCollectionName as au, Mutable as av, UnpackList as aw, Merge as ax, MergeOptional as ay, NeverToUnknown as az, WebSocketEvents as b, WebSocketEventHandler as c, WebSocketClient as d, SubscriptionOptionsEvents as e, SubscriptionEvents as f, SubscriptionOutput as g, SubscriptionPayload as h, DirectusCollection as i, CoreSchema as j, DirectusDashboard as k, DirectusExtension as l, ExtensionTypes as m, DirectusField as n, FieldMetaConditionOptionType as o, FieldMetaTranslationType as p, DirectusFile as q, DirectusFlow as r, DirectusFolder as s, DirectusNotification as t, DirectusOperation as u, DirectusPanel as v, DirectusPermission as w, DirectusPreset as x, DirectusRelation as y, DirectusRevision as z };
